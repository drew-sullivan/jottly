...
export const allowedValues = Object.freeze({
  ...
  event: [
    ...
    "community_section_opened", "community_game_selected", "community_game_started", "community_game_saved",
    "community_catalog_cache_used", "community_catalog_refresh_succeeded", "community_catalog_refresh_failed",
  ...
  community_selection_source: ["weekly_popular", "recently_popular", "featured"],
  context: [
    ...
    "shared_game", "community_catalog", "invitation", "game_routing", "notification_permission",
...
const reliabilityEvents = new Set([
  ...
  "move_submission_failed", "community_catalog_refresh_failed",
  "local_events_dropped",
]);
const dimensionsByEvent = Object.freeze({
  ...
  mode_selected: ["mode", "game_source", "context"],
  ...
  community_section_opened: ["context"],
  community_game_selected: ["mode", "game_source", "game_kind", "word_length", "context", "community_selection_source"],
  community_game_started: ["mode", "game_source", "game_kind", "word_length", "context", "community_selection_source"],
  community_game_saved: ["mode", "game_kind", "word_length", "context", "community_selection_source"],
  community_catalog_cache_used: ["context"],
  community_catalog_refresh_succeeded: ["context"],
  community_catalog_refresh_failed: ["context"],
...
const requiredDimensionsByEvent = Object.freeze({
  ...
  shared_game_reshared: ["mode", "game_kind", "word_length", "context"],
  community_section_opened: ["context"],
  community_game_selected: ["mode", "game_source", "context", "community_selection_source"],
  community_game_started: ["mode", "game_source", "context", "community_selection_source"],
  community_game_saved: ["mode", "context", "community_selection_source"],
  community_catalog_cache_used: ["context"],
  community_catalog_refresh_succeeded: ["context"],
  community_catalog_refresh_failed: ["context"],
  offline_fallback_entered: ["reliability_reason"],
