...
export function buildDashboardModel(inputRows, filters = {}) {
  ...
  const model = {
    ...
    community: {
      sectionOpened: eventCount("community_section_opened"),
      selected: eventCount("community_game_selected"),
      started: eventCount("community_game_started"),
      saved: eventCount("community_game_saved"),
      observedStartRatio: ratio(eventCount("community_game_started"), eventCount("community_game_selected")),
      selectionsBySource: groupedCounts(
        rows,
        "community_selection_source",
        (row) => row.event === "community_game_selected",
      ),
      startsBySource: groupedCounts(
        rows,
        "community_selection_source",
        (row) => row.event === "community_game_started",
      ),
      cacheUsed: eventCount("community_catalog_cache_used"),
      refreshSucceeded: eventCount("community_catalog_refresh_succeeded"),
      refreshFailed: eventCount("community_catalog_refresh_failed"),
    },
