CREATE TABLE IF NOT EXISTS anonymous_analytics_events_v6 (
...
INSERT OR IGNORE INTO anonymous_analytics_events_v6 (
  ...
  duration_bucket, outcome, performance_bucket, reliability_reason,
  community_selection_source, context, reason, install_cohort, aggregate_count
)
